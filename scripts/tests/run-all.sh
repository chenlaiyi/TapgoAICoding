...
"$ROOT/scripts/tests/evolution-preflight-test.sh"
"$ROOT/scripts/tests/evolution-schema-test.sh"
"$ROOT/scripts/tests/evolution-archive-test.sh"
"$ROOT/scripts/tests/evolution-maintenance-test.sh"
