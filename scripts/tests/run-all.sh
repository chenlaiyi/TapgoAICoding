...
"$ROOT/scripts/tests/app-sources-parse-test.sh"
"$ROOT/scripts/tests/evolution-deps-test.sh"
...
"$ROOT/scripts/tests/evolution-maintenance-selftest-test.sh"
"$ROOT/scripts/tests/evolution-feedback-test.sh"
"$ROOT/scripts/tests/evolution-feedback-draft-test.sh"
"$ROOT/scripts/tests/evolution-feedback-funnel-test.sh"
"$ROOT/scripts/tests/worktree-verify-test.sh"
"$ROOT/scripts/tests/evolution-ui-snapshot-test.sh"
"$ROOT/scripts/tests/evolution-ui-assert-test.sh"
"$ROOT/scripts/tests/evolution-h5-render-test.sh"
"$ROOT/scripts/tests/evolution-drift-test.sh"
"$ROOT/scripts/tests/deploy-fleet-test.sh"
"$ROOT/scripts/tests/canary-promote-test.sh"
