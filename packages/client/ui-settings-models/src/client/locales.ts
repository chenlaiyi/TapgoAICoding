...
export const en = {
  ...
  welcomeBody: 'Tapgo AICoding is based on the open-source DeepSeek Harness preview. This version is still evolving; plugins, APIs, and saved data formats may change. Please back up important work and send feedback when something fails.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Tapgo AICoding 基于开源 DeepSeek Harness 预览版。当前版本仍在演进，插件、API 和存储格式可能变化。请备份重要工作，遇到问题时向我们反馈。',
  welcomeContinue: '继续',
