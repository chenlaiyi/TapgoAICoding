...
export const en = {
  ...
  loading: 'Loading…', backToHarness: 'Back to Tapgo AICoding',
  ...
  quotaDescription: 'Tapgo AICoding cannot start a new task with this account when no balance is available. Would you like to top up? You can also top up later in Settings → Account.',
  quotaTopUp: 'Top up',
...
export const zh: Record<AccountKey, string> = {
  ...
  loading: '加载中…', backToHarness: '返回 Tapgo AICoding',
  ...
  quotaTitle: '当前无可用余额',
  quotaDescription: '没有可用额度时，Tapgo AICoding 无法开始新的任务，是否前往充值？或者可以稍后前往 设置 → 账号与余额 进行充值。',
  quotaTopUp: '去充值',
