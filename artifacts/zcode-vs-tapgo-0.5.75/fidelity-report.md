...
| Token | 目标 IDE asar 期望 | DSHTheme 实际 | 匹配 |
| --- | --- | --- | --- |
| brandBlueZCode | `0x4099FF` | `0x4099FF` | ✅ |
| warnZCode | `0xCD8900` | `0xCD8900` | ✅ |
| errorZCode | `0xE40014` | `0xE40014` | ✅ |

## 2. Desktop: 目标 IDE interaction design assertion 通过率

```
swift run TapgoTests --filter 'Desktop: 目标 IDE interaction design'
…
— 46 passed, 0 failed —
```

## 3. Tapgo vs 目标 IDE 中央 1000x740 区域 pixelmatch %（Verifier 硬性要求）

```json
{
  "source": {
    "tapgo": "/Users/chanlaiyi/TapgoAICoding/artifacts/fidelity-vs-tapgo-0.5.75/tapgo-main.png",
    "reference": "/Users/chanlaiyi/TapgoAICoding/artifacts/fidelity-vs-tapgo-0.5.75/01-baseline.png"
  },
  "original": {
    "tapgo": {
      "w": 963,
...
## 4. 同区域色差对比（目标 IDE 1220x1287 主窗口 vs Tapgo 963x1344 主窗口）
...
```
/Users/chanlaiyi/TapgoAICoding/artifacts/fidelity-vs-tapgo-0.5.75/01-baseline.png 1220x1287
...
```
/Users/chanlaiyi/TapgoAICoding/artifacts/fidelity-vs-tapgo-0.5.75/tapgo-main.png 963x1344
...
- `01-baseline.png` — 目标 IDE 3.10.2 主窗口 1220×1287（screencapture -l<wid> 抓取 wid=64377）
- `tapgo-main.png` — Tapgo AICoding v0.5.75 主窗口 963×1344（screencapture -l64836 抓取）
- `01-sidebar-droptarget.png` / `02-main-bottom-error.png` / `03-toolbar-status.png` — 目标 IDE 主窗口的 3 个区域切图（brandBlueZCode / errorZCode / warnZCode 挂载点对照区）
