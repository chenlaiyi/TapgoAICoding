...
export const en = {
  ...
  aboutMenu: 'About Tapgo AICoding',
  aboutProduct: 'Tapgo AICoding',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide Tapgo AICoding',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Tapgo AICoding',
  openApplication: 'Open Tapgo AICoding',
  quit: 'Quit',
  cancel: 'Cancel',
  quitTitle: 'Quit Tapgo AICoding?',
  ...
  startupFailed: 'Tapgo AICoding is unavailable',
  ...
  welcomeTitle: 'Tapgo AICoding',
  welcomeBrand: 'Tapgo AICoding',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Tapgo AICoding',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: 'Tapgo AICoding v{version} downloaded',
  ...
  updateTitle: 'Tapgo AICoding Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Tapgo AICoding {version}\n\nTapgo AICoding will restart to complete the update.',
...
export const zh = {
  ...
  fileMenu: '文件',
  closePage: '关闭页面或窗口',
  aboutMenu: '关于 Tapgo AICoding',
  aboutProduct: 'Tapgo AICoding',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 Tapgo AICoding',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Tapgo AICoding',
  openApplication: '打开 Tapgo AICoding',
  quit: '退出',
  cancel: '取消',
  quitTitle: '退出 Tapgo AICoding？',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Tapgo AICoding 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Tapgo AICoding v{version} 下载完成',
  ...
  updateTitle: 'Tapgo AICoding 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Tapgo AICoding {version}\n\nTapgo AICoding 将重启以完成更新。',
