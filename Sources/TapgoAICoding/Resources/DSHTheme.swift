...
enum DSHTheme {
    ...
    static let fidelityMainCanvas  = Color.dynamic(lightHex: 0xFFFFFF, darkHex: 0x181818)
    static let welcomeBorder = Color.dynamic(lightHex: 0xDEDEDE, darkHex: 0x333333)
    static let welcomeHover = Color.dynamic(lightHex: 0xF5F5F5, darkHex: 0x222222)
    static let composerSurface = Color.dynamic(lightHex: 0xF4F4F4, darkHex: 0x282828)
    static let composerProjectSurface = Color.dynamic(lightHex: 0xEAEAEA, darkHex: 0x222222)
    static let composerAction = Color.dynamic(lightHex: 0x202020, darkHex: 0xF5F5F5)
    static let composerActionText = Color.dynamic(lightHex: 0xFFFFFF, darkHex: 0x181818)
