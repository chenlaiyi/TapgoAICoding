...
enum L10n {
    ...
    static let providerZhipuSection = "智谱"
    static let providerCustomSection = "自定义供应商"
    static let providerBuiltinBadge = "已启用"
    static let providerAddProvider = "添加供应商"
    static let providerDragReorder = "拖拽调整供应商顺序"
    static let providerRefresh = "刷新"
    static let providerHeaderDesc = "管理自定义模型供应商，配置后可在聊天时选择使用。"
    static let providerEditConfig = "编辑模型配置"
    static let providerEditAction = "编辑"
    static let providerAddModel = "添加模型"
    static let providerRemoveConfirm = "删除供应商「%@」？"
    static let providerRemoveHint = "将删除该供应商下所有自定义模型；新建会话时将无法选择。"
    static let providerDragHint = "拖拽调整供应商顺序即将推出。"
    static let providerAPIBaseURL = "端点 Base URL"
    static let providerAPIBrand = "品牌"
    static let providerContextWindow = "上下文窗口：%@"
