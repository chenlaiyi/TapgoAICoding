...
func runAppUpdateDistribution(_ t: TestRunner) {
    ...
    t.expectEqual(info["CFBundleShortVersionString"] as? String, "0.5.68", "update: 主 App 版本")
    t.expectEqual(helperInfo["CFBundleShortVersionString"] as? String, "0.5.68", "update: Helper 版本")
    ...
    t.expect(appcast.contains("Tapgo-AICoding-0.5.68.zip"), "update: appcast 指向当前归档")
